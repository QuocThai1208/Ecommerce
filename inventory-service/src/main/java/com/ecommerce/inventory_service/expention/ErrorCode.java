...
public enum ErrorCode {
    ...
    WAREHOUSE_NOT_EXISTED(1021, "Ware house not existed.", HttpStatus.BAD_REQUEST),
    INVENTORY_NOT_EXISTED(1022, "Inventory not existed.", HttpStatus.BAD_REQUEST),
    QUANTITY_INFLOW_INVALID(1023, "The quantity stored must be greater than 0.", HttpStatus.BAD_REQUEST),
    QUANTITY_ORDER_INVALID(1024, "The quantity order must be greater than 0.", HttpStatus.BAD_REQUEST),
    QUANTITY_CHECK_INVALID(1025, "The quantity check must be greater than 0.", HttpStatus.BAD_REQUEST),
    INSUFFICIENT_QUANTITY(1026, "Số lượng đặt hàng trong kho không đủ.", HttpStatus.BAD_REQUEST),
    VARIANT_NOT_EXISTED(1028, "Hàng không tồn tại", HttpStatus.BAD_REQUEST),
